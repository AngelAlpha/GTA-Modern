function sendReadyMessage()
	triggerServerEvent("loadammo:boneAttach_requestAttachmentData",root)
end
...
addEvent("loadammo:boneAttach_sendAttachmentData",true)
addEventHandler("loadammo:boneAttach_sendAttachmentData",root,getAttachmentData)

function initAttach()
	addEvent("loadammo:boneAttach_attach",true)
	addEvent("loadammo:boneAttach_detach",true)
	addEventHandler("loadammo:boneAttach_attach",root,attachElementToBone)
	addEventHandler("loadammo:boneAttach_detach",root,detachElementFromBone)
end
