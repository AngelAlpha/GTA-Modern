...
availableTranslations = {
	["ru"] = {
		...
		["menu.extras.frontWheelSize"] = "Размер передних колес",
		["menu.extras.rearWheelSize"] = "Размер задних колес",
		["menu.extras.offroad"] = "Резина",
		...
		["tuningPack.0"] = "Стандарт",
		["tuningPack.1"] = "Поставить",
		--["tuningPack.2"] = "Silver Pack",
		--["tuningPack.3"] = "Gold Pack",
		["tuningPack.wheelSize.veryNarrow"] = "Очень узкие",
		["tuningPack.wheelSize.narrow"] = "Узкие",
		["tuningPack.wheelSize.wide"] = "Широкие",
		["tuningPack.wheelSize.veryWide"] = "Очень широкие",
		["tuningPack.offroad.dirt"] = "Грязь",
		["tuningPack.offroad.sand"] = "Песок",
		["tuningPack.antiradar"] = "Антирадар",
		["tuningPack.sab"] = "Сабвуфер",
		...
		["tuningPrice.free"] = "Бесплатно",
		["tuningPack.remove"] = "Убарть",
		["tuningPack.install"] = "Установить",
		["tuning.active"] = "Установлено",
		
		["navbar.select"] = "Выбрать",
		["navbar.buy"] = "Купить",
		["navbar.navigate"] = "Навигация",
		["navbar.back"] = "Назад",
		["navbar.exit"] = "Выйти",
		["navbar.camera"] = "Камера",
		
		["notification.error.notCompatible"] = "Компонент (%s) нельзя установить на вашу машину!",
		["notification.error.itemIsPurchased"] = "Компонент (%s) уже установлен!",
		["notification.error.notEnoughMoney"] = "Нету денег!",
		["notification.success.purchased"] = "Куплено!",
		["notification.warning.airRideInstalled"] = "ПРЕДУПРЕЖДЕНИЕ!\nДля установки пневмы.\nуберите гидравлику с машины!",
		
		["prompt.text"] = "Вы действительно хотите купить это?",
		["prompt.info.1"] = "Выбранный элемент",
		["prompt.info.2"] = "Стоимость",
		["prompt.button.1"] = "Купить (Enter)",
		["prompt.button.2"] = "Отмена (Backspace)",
		
		["message.airride.error"] = "Используйте: /airride [0 - 5] (0 => стандарт)",
	},
	["en"] = {
