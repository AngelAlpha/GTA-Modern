...
addEventHandler("onClientRender",root,
    function()
        dxDrawFramedText(curMessage,curLeft,(screenHeight / 900) * 618.0,curLeft + ((screenWidth / 1440) * 456.0),(screenHeight / 900) * 645.0,tocolor(curColor[1],curColor[2],curColor[3],255),1.0,"default-bold","center","center",false,true,true)
    end
)
